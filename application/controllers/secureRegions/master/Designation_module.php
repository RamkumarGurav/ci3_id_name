...
class Designation_module extends Main
{
	...
	function do_edit()
	{
		...
		if (!empty($id)) {
			...
			$insertStatus = $this->Common_model->update_operation(array('table' => 'designation', 'data' => $enter_data, 'condition' => "id = $id"));
			...
			$insertStatus = $this->Common_model->add_operation(array('table' => 'designation', 'data' => $enter_data));
			if (!empty($insertStatus)) {
